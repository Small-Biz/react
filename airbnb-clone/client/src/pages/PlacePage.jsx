...
export default function PlacePage(){
        ...
        return (
            <div className="absolute inset-0 bg-black text-white min-h-screen">
                <div className="p-8 grid gap-4 bg-black">
                    <div>
                        <h2 class="text-3xl mr-40">Photos of {place.title}</h2>
    ...
    return (
        <div className="mt-4 bg-gray-100 -mx-8 px-8 pt-8">
            ...
            <a className="flex gap-1 my-2 block font-semibold underline" target="_black" href={'https://maps.google.com/?q='+place.address}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <div className="relative">
                ...
                <button onClick={()=> setShowAllPhotos(true)} className="flex gap-2 absolute bottom-2 right-2 py-2 px-4 bg-white rounded-full shadow shadow-md shadow-gray-500">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
