...
import PhotosUploads from "../PhotosUploader";
    ...
    return (
        <div>
            ...
            <form onSubmit={savePlace}>
                ...
                <input type="text" value={address} onChange={ev=>setAddress(ev.target.value)} placeholder=""/>
                ...
                {preInput('Perks','select all the perk')}
