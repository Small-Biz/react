...
export default function(){
    ...
    async function getAnnouncements(){
        ...
        var response=await axios.get('http://localhost:8090/hkex/getAnnouncements?instrumentCode=00003&numPerPage=10&page='+currPage);
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <div id="main-content-container">
                <div className="announcements-container">
                    <div><span className="announcements-table-title">Financial Reports</span></div>
